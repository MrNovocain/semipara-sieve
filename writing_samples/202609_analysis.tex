...
\author{%
    Zongwu Cai \quad Yifeng Chen \quad Seok Young Hong \quad Daniel Tsvetanov\\[4pt]
...
by Cai, Chen, Hong, and Tsvetanov (2026).
...
\begin{enumerate}[leftmargin=*, label=\textbf{Stage \arabic*:}]
    ...
    to estimate $\alpha$ (following Cai \& Wang, 2014).
...
\begin{enumerate}[leftmargin=*, label=\textbf{\arabic*}.]
    ...
    Estimate $\alpha$ via the Cai--Wang (2014) method, yielding
